...
var mixer = mixitup(workContainer, {
    selectors: {
        target: document.querySelector('.word__card')
    },
    animation: {
        duration: 300
    }
...
function sendEmail(){
    Email.send({
        Host : "smtp.gmail.com",
        Username : "vvilliamchung99@gmail.com",
        Password : "uiuhjjgdegsjqjja",
        To : 'vvilliamchung99@gmail.com',
